            ...
            return (
              <Card key={d.id} className="border-zinc-800 bg-zinc-900/50">
                ...
                <CardContent className="space-y-4">
                  <div>
                    <span className="text-[10px] uppercase tracking-wider text-zinc-500">Rationale</span>
                    <p className="text-xs text-zinc-300 mt-1 leading-relaxed">{d.rationale}</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-zinc-300">{d.mode}</p>
                      </div>
                    </div>
                  </div>
