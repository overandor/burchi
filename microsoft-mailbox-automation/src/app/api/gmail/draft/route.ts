...
import { createDraftREST } from "@/lib/gmail/rest-client";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await createDraftREST(
      { clientId, clientSecret, redirectUri, refreshToken, emailAddress: "" },
      { to: body.to, cc: body.cc, subject: body.subject, body: body.body, isHtml: body.isHtml }
    );
